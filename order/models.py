...
class Order(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='order', default=0)
    # phone = models.CharField(max_length=12)
    address = models.CharField(max_length=40, default="Gagarina street, 55")
    date = models.DateField(default=timezone.now)
    delivery_time = models.ForeignKey(Time, on_delete=models.CASCADE, related_name='delivery_time', default=0)
